			...
			<head>
				<xsl:choose>
					<xsl:when test="kml:kml">
						<title>Locations Sitemap - KASONGS4U | Kannada A to Z Mp3 Songs Free Download</title>
					</xsl:when>
					<xsl:otherwise>
						<title>XML Sitemap - KASONGS4U | Kannada A to Z Mp3 Songs Free Download</title>
					</xsl:otherwise>
				</xsl:choose>
					...
					<xsl:when test="kml:kml">
						...
						<div id="description">
							...
							<h1>KML File</h1>
															...
															<p>
									This KML Fiile is generated by the <a href="https://rankmath.com/" target="_blank">Rank Math WordPress SEO Plugin</a>. It is used to provide location information to Google.								</p>
					...
					<xsl:otherwise>
						...
						<div id="description">
							...
							<h1>XML Sitemap</h1>
															...
															<p>
									This XML Sitemap is generated by the <a href="https://rankmath.com/" target="_blank">Rank Math WordPress SEO Plugin</a>. It is what search engines like Google use to crawl and recrawl posts/pages/products/images/archives on your website.								</p>
